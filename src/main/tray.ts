...
let Tray: any, Menu: any, nativeImage: any, BrowserWindow: any, app: any
try {
  ...
  Tray = class Tray { on() {} setToolTip() {} setContextMenu() {} destroy() {} }
  Menu = class Menu { static buildFromTemplate() { return new Menu() } }
