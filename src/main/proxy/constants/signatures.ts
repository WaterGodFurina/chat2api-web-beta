 ...
 */
export type ToolCallFormat = 'bracket' | 'xml' | 'anthropic' | 'json' | 'native' | 'chat2api_xml' | 'unknown'
...
export const FORMAT_SIGNATURES: Record<ToolCallFormat, string[]> = {
  ...
  native: [],
  chat2api_xml: ['<|CHAT2API|tool_calls>', '<|CHAT2API|invoke', '</|CHAT2API|tool_calls>', '<|CHAT2API|parameter'],
  unknown: [],
}
