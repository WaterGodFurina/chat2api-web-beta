...
export interface ToolClientAdapterMeta {
  id: 'standard-openai-tools' | 'cherry-studio-mcp' | 'astrbot'
  label: string
...
export const P0_TOOL_CLIENT_ADAPTERS: ToolClientAdapterMeta[] = [
  ...
  },
  {
    id: 'astrbot',
    label: 'AstrBot',
    descriptionKey: 'toolCalling.clients.astrBotDesc',
    smokeTestKind: 'openai-tools',
  },
]
...
function isClientAdapterId(value: unknown): value is ToolClientAdapterId {
  return value === 'standard-openai-tools' || value === 'cherry-studio-mcp' || value === 'astrbot'
}
